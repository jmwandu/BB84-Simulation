...
def quickPresentation(bit_size):
    ...
    print("The calculated QBER is: " + str(100*qber_calculated) + "%")
    print("The actual QBER is: " + str(100*qber_actual) + "%")
    print("The calculated secure key rate is: " + str(secureKeyRate(qber_calculated)))
    print("The actual secure key rate is: " + str(secureKeyRate(qber_actual)))
...
def quickSimulation(bit_size):
    ...
    return (raw_sifted_key_length, final_key_length, calculated_secure_key_rate, actual_secure_key_rate, qber_calculated, qber_actual)
